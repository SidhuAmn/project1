...
public class Play {
	...
	public static void main(String[] args) {
		...
		startGame();
		if(counter.calculateDeadwood(player.getHand())<
				counter.calculateDeadwood(computer.getHand()))
	...
	public static void startGame() {
		...
		while(!declare) {
			playerTurn(discard);
			System.out.println("press 3 to declare or other key to proceed");
			if(in.nextInt()==3) {
				declare=true;
				break;
			}
